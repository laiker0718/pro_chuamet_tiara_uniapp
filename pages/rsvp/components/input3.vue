...
<script>
    ...
    export default {
        ...
        beforeMount() {},
        mounted() {
            this.name = getApp().globalData.userInfo.name
            this.type = getApp().globalData.userInfo.type
            this.age = getApp().globalData.userInfo.age
            this.city = getApp().globalData.userInfo.city
        },
        beforeUpdate() {},
        updated() {},
        beforeDestroy() {},
                ...
                uni.request({
                    ...
                    success: res => {
                        ...
                        if (res.data.status == 0) {
                            ...
                            // 不存
                            getApp().globalData.isModified = true
